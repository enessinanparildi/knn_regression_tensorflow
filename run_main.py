...
if __name__ == "__main__":
    ...
    testloss, testpred, kval = knn_regression_tensorflow.main_graph(traindata, validdata, testdata, kset)
    print('Test mse loss= ' + str(testloss))
    knn_regression_tensorflow.plot_results(testdata, testpred, kval)
